...
export default function About() {
  return (
    <>
      <Layout headerStyle={1} footerStyle={2} breadcrumbTitle="Hakkımızda">
        <div>
          <section
                    ...
                    <div className="about-content">
                      <div className="section-title">
                        ...
                        <h2 className="wow fadeInUp" data-wow-delay=".3s">
                          İşlerinizi <span>teknolojiye</span> uygun şekilde
                          otomatize ediyoruz
                        </h2>
                      </div>
                      <p
                      ...
                      <div className="about-icon-items">
                        ...
                        >
                          ...
                          <div className="content">
                            <h4>Problem Çözümü</h4>
                            <p>İş Problemlerini Otomatize Ediyoruz</p>
                          </div>
                        </div>
                        <div
                          className="icon-items wow fadeInUp"
                        ...
                        >
                          ...
                          <div className="content">
                            <h4>Misyon &amp; Vizyon</h4>
                            <p>Yenilikçi , modern , kullanışlı.</p>
                          </div>
                        </div>
                      </div>
          ...
          <section className="offer-section fix section-bg-2 section-padding">
            ...
            <div className="container">
              <div className="section-title text-center">
                <span className="wow fadeInUp">Bizim Teklifimiz</span>
                <h2 className="text-white wow fadeInUp" data-wow-delay=".3s">
                  Teknoloji trendlerini <br /> yakalamak
                </h2>
              </div>
              <div className="row">
                <div
          ...
          <section className="project-section-2 section-padding fix">
            ...
            <div className="container">
              <div className="section-title-area">
                <div className="section-title">
                  <span className="wow fadeInUp">PROJELER</span>
                  <h2 className="wow fadeInUp" data-wow-delay=".3s">
                    En Son Teslim <br /> Edilen Projeler
                  </h2>
                </div>
          ...
          <section className="team-section-3 fix pt-0 section-padding">
            <div className="container">
              <div className="section-title-area">
                <div className="section-title">
                  <span className="wow fadeInUp">Ekip Üyeleri</span>
                  <h2 className="wow fadeInUp" data-wow-delay=".3s">
                    Ekibimizdeki Önemli <br /> Üyeler
                  </h2>
                </div>
                <Link
                  href="/team"
              ...
              <div className="row">
                ...
                >
                  <div className="single-team-items">
                    <div className="team-image">
                      <img src="/assets/img/diyap.jpeg" alt="team-img" />
                    ...
                    <div className="team-content text-center">
                      <h3>
                        <Link href="#">Diyap Esen Kaba</Link>
                      </h3>
                      <p>Kurucu </p>
                    </div>
                  </div>
                ...
                >
                  <div className="single-team-items">
                    <div className="team-image">
                      <img src="/assets/img/aydın.jpeg" alt="team-img" />
                      <div className="social-profile">
                        <ul>
                          <li>
                            <Link href="#">
                ...
                >
                  <div className="single-team-items">
                    <div className="team-image">
                      <img src="/assets/img/merve.webp" alt="team-img" />
                      <div className="social-profile">
                        <ul>
                          <li>
                            <Link href="#">
                ...
                >
                  <div className="single-team-items">
                    <div className="team-image">
                      <img src="/assets/img/hilal.avif" alt="team-img" />
                      <div className="social-profile">
                        <ul>
                          <li>
                            <Link href="#">
