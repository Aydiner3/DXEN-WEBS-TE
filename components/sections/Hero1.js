            ...
            <div className="col-lg-8">
              <div className="hero-content">
                <h6 className="wow fadeInUp" data-wow-delay=".2s">
                  En iyi IT çözüm sağlayıcısı
                </h6>
                <h1 className="wow fadeInUp" data-wow-delay=".4s">
                  DXEN TEKNOLOJİ
                </h1>
                <p className="wow fadeInUp" data-wow-delay=".6s">
                  DXEN Teknoloji, dijitalde büyüme potansiyeli olan ve bu konuda
                  tutkulu; <br />
                  küçük, orta ve büyük olmak üzere her segmentteki işletmelere
                  yazılım firması
                  <br /> olarak çözüm sunmaktadır.
                </p>
