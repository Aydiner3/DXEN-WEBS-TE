...
export default function Contact() {
  return (
    <>
      <Layout headerStyle={1} footerStyle={2} breadcrumbTitle="İletişim">
        <div>
                ...
                <div className="row g-4 align-items-center">
                    ...
                    <div className="contact-left-items">
                      <div className="contact-info-area-2">
                        ...
                        <div className="contact-info-items border-none">
                          ...
                          <div className="content">
                            <p>Lokasyon</p>
                            <h3>Akatlar Mah. Beşiktaş/TÜRKİYE</h3>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="contact-content">
                      ...
                      <p>
                        Bize ulaşmak ve fiyat teklifleri almak için formu
                        doldurabilir veya telefon numaramız ya da mail adresimiz
                        aracılığı ile iletişime geçebilirisiniz.
                      </p>
                      <form
                        action="contact.php"
                        id="contact-form"
          ...
          <div className="map-section">
            <div className="map-items">
              <div className="googpemap">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d187.9441153680305!2d29.021796063679243!3d41.088533932462546!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cab6735a004305%3A0x7ea9ca23fac54!2sAkat%2C%205.%20Gazeteciler%20Sitesi%2C%2034335%20Be%C5%9Fikta%C5%9F%2F%C4%B0stanbul!5e0!3m2!1str!2str!4v1713087667642!5m2!1str!2str"
                  style={{ border: 0 }}
                  allowFullScreen
                  loading="lazy"
                />
